  ...
  return (
    <div className="bg-white text-black font-sans w-full">
      ...
      <section className="text-center py-10 px-4">
        <h2 className="text-sm text-gray-500 uppercase mb-6">
          Get ahead with InternAIze
        </h2>
      ...
      <section id="about" className="bg-green-50 py-10 px-4">
      ...
      <footer className="text-center py-6 text-xs text-gray-500 border-t px-4">
        <p>
          Copyright © 2024-2025. <strong>InternAIze</strong> and logo are
          proprietary trademarks of <strong>InternAIze</strong>.
        </p>
